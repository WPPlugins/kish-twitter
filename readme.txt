...
== Description ==
This plugin is using the Twitter  API to get and post the updates. You need to register a twitter application. You can brand your tweets using this plugin
